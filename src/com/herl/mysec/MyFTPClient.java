...
*/
	...
	public boolean ftpDownload(String desFilePath, String srcFileName)
	{
	...
	try {
		...
		File targetFile = new File(desFilePath,srcFileName);
		if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
		{ 
			FileOutputStream fos;
			fos = new FileOutputStream(targetFile);
			status = mFTPClient.retrieveFile("/"+srcFileName, fos); 
		}         
