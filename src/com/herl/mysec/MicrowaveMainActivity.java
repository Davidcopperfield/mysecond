...
public class MicrowaveMainActivity extends Activity {
	public String strtime=null,str1=null,str2=null,stronoff=null,strsafe=null,str5 = null;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_microwave_main);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.microwave_main, menu);
		return true;
	}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_microwave_main,
					container, false);
			return rootView;
		}
	}
